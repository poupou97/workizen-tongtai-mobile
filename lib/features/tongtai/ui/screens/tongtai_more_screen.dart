          ...
          children: [
            ...
            _SettingsSection(
              ...
              items: [
                ...
                _SettingsItem(
                  key: const Key('more-import'),
                  icon: Icons.table_chart_outlined,
                  label: context.l10n.titleImport,
                  onTap: () => Navigator.of(context).push<void>(
                    MaterialPageRoute(
                      builder: (_) => const TongtaiImportScreen(),
                    ),
                  ),
                ),
                _SettingsItem(
                  key: const Key('more-connections'),
                  icon: Icons.hub_outlined,
                  label: context.l10n.titleConnections,
                  onTap: () => Navigator.of(context).push<void>(
                    MaterialPageRoute(
                      builder: (_) => const TongtaiConnectionsScreen(),
                    ),
                  ),
                ),
                _SettingsItem(
