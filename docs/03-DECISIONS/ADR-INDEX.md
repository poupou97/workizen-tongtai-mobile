...
| [ADR-TON-004](ADR-TON-004-chat-persistence-local-only.md) | Chat persistence **local-only** (bảng v4, KHÔNG vào sync outbox — chờ D-5); mã hoá = chuẩn nền tảng, SQLCipher là option chờ Founder | ✅ ACCEPTED (Founder) | 2026-07-23 |
