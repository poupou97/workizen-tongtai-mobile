...
| ~~App icon/splash = Flutter default~~ → ✅ **WTM-110**: Origami Business Fox (concept 08a) — flutter_launcher_icons (Android adaptive + iOS, alpha-stripped) + flutter_native_splash (navy). Nguồn: `assets/branding/app_icon*.svg` | ✅ đóng | — |
