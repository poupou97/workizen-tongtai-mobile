...
| `tongtai_activity_screen` | `agentActivityProvider` (3 bảng vòng đời + số bản ghi đã quét) | `TongtaiAsyncScreenData` | **WTM-305 · trải nghiệm #5.** Gộp theo **ngày**, không theo loại — người bán nhớ "hôm nay tôi đã làm gì". Không dòng nào chứa tên bảng/mã lỗi/id; có test khoá |
